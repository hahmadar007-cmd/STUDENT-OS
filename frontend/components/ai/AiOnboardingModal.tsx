  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={dismiss}
          className="absolute top-4 right-4 text-fouzar-text-primary/25 hover:text-fouzar-text-primary/60 transition-colors cursor-pointer"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="px-7 pt-7 pb-2">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h2 className="font-mono text-[15px] font-bold text-fouzar-text-primary/90 uppercase tracking-wider">Connect your AI</h2>
          </div>
          <p className="font-mono text-[9px] text-fouzar-text-primary/35 mt-2 leading-relaxed">
        ...
        <div className="px-7 py-5 space-y-4">
              ...
              return (
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.04] border border-fouzar-border-subtle rounded-lg px-3 py-2 text-[12px] text-fouzar-text-primary/90 placeholder-white/20 font-mono focus:outline-none focus:border-white/25 transition-colors"
                  />
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/[0.04] border border-fouzar-border-subtle rounded-lg px-3 pr-10 py-2 text-[12px] text-fouzar-text-primary/90 placeholder-white/20 font-mono focus:outline-none focus:border-white/25 transition-colors"
                    />
                    <button
                      type="button"
                      onClick={() => updateEntry(i, 'showKey', !entry.showKey)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-fouzar-text-primary/25 hover:text-fouzar-text-primary/55 cursor-pointer"
                    >
                  ...
                  <select
                    ...
                    className="w-full bg-white/[0.04] border border-fouzar-border-subtle rounded-lg px-3 py-1.5 text-[11px] text-fouzar-text-primary/70 font-mono focus:outline-none focus:border-white/25 transition-colors cursor-pointer"
                  >
                    ...
                    <option value="CUSTOM" className="bg-fouzar-bg">CUSTOM</option>
                  </select>
                  ...
                  <AnimatePresence>
                    {entry.validStatus === 'testing' && (
                      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                        className="flex items-center gap-1.5 font-mono text-[9px] text-fouzar-text-primary/40">
          ...
          {entries.length < 3 && (
            <button
              type="button"
              onClick={addEntry}
              className="flex items-center gap-1.5 font-mono text-[9px] uppercase tracking-wider text-fouzar-text-primary/30 hover:text-[#7c5cfc] transition-colors cursor-pointer"
            >
          ...
          <p className="font-mono text-[7.5px] text-fouzar-text-primary/20 flex items-center gap-1">
        ...
        <div className="px-7 pb-7 flex flex-col gap-2">
          ...
          {hasAnyFail && (
            <button
              ...
              disabled={isSaving}
              className="w-full py-2 font-mono text-[9px] uppercase tracking-wider text-fouzar-text-primary/30 hover:text-fouzar-text-primary/55 transition-colors cursor-pointer"
            >
          ...
          <button
            onClick={dismiss}
            className="w-full py-2 font-mono text-[9px] uppercase tracking-wider text-fouzar-text-primary/20 hover:text-fouzar-text-primary/40 transition-colors cursor-pointer"
          >
            Skip for now
          </button>
        </div>
